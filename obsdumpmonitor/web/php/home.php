...
<?# NAM ?>
 <div id="p" class="gray">
  ...
  Looks through <font class="courier">/com/arch/prod/obcount_30day/nam/*/*</font> for report counts in tank b006/xx001 (NEXRAD radial wind superobs (Level 3 - NIDS)) during the past 30 days.
 <div id="script">
 <a href="scripts/view22n_2" target="_blank">view script</a>
  ...
  Looks through <font class="courier">/com[2]/logs/jlogfile</font> and <font class="courier">/com[2]/logs/jlogfile.old.*</font> for the start times of the NAM dump.
 <div id="script">
...
<? # RAP ?>
 <div id="p" class="gray">
  ...
  Looks through <font class="courier">/com[2]/logs/jlogfile</font> and <font class="courier">/com[2]/logs/jlogfile.old.*</font> for missing wind profiler information in the RAP dump.
 <div id="script">
 <a href="scripts/view22y_2" target="_blank">view script</a>
  ...
  Looks through <font class="courier">/com[2]/logs/jlogfile</font> and <font class="courier">/com[2]/logs/jlogfile.old.*</font> (to cover 24 hours) for any missing information in RAP dump.
 <div id="script">
...
<? # RTMA, URMA ?>
 <div id="p" class="gray">
  <strong><a name="rtmaurma">RTMA, URMA</a></strong><br />
  <strong><a href="?log=view22y_5&wcoss=<?=$wcoss?>">All Messages</a></strong><br />
  Looks through <font class="courier">/com[2]/logs/jlogfile</font> and <font class="courier">/com[2]/logs/jlogfile.old.*</font> for missing components of dumps.
 <div id="script">
...
<? # Non-fata/Abnormal RCs ?>
 <div id="p" class="gray">
  ...
  Looks through <font class="courier">/com[2]/logs/jlogfile</font> and <font class="courier">/com[2]/logs/jlogfile.old.*</font> for non-fatal / abnormal RCs in all networks except RAP, RTMA, and URMA.
 <div id="script">
...
<? # RC=22 ?>
 <div id="p" class="gray">
  ...
  <strong><a href="?log=view22n_7&wcoss=<?=$wcoss?>">All networks except rap, rtma, urma and 1b data dumps</a></strong><br />
  Looks through <font class="courier">/com[2]/logs/jlogfile</font> and <font class="courier">/com[2]/logs/jlogfile.old.*</font> for RC=22 in all networks except RAP, RTMA, and URMA dumps.
 <div id="script">
 <a href="scripts/view22n_7" target="_blank">view script</a>
 </div>
 </div>
<? # *.out ?>
 <div id="p" class="gray">
...
<? # RC=11 ?>
 <div id="p" class="gray">
  ...
  <font class="courier">$UT/view11</font><br />
  Greps through all data types in <font class="courier">/com[2]/logs/jlogfile</font> and <font class="courier">/com[2]/logs/jlogfile.old.*</font> for RC=11, meaning 1 or more components of a dump are missing.
 <div id="script">
 <a href="scripts/view11" target="_blank">view script</a>
 </div>
 </div>
<? # FAILURES ?>
 <div id="p" class="gray">
  <strong><a href="?log=viewfail&wcoss=<?=$wcoss?>" name="failures">FAILURES</a></strong><br />
  <font class="courier">$UT/viewfail</font><br />
  Greps through <font class="courier">/com[2]/logs/jlogfile</font> and <font class="courier">/com[2]/logs/jlogfile.old.*</font> for the following failure patterns:<br />
  ABNORMAL EXIT, ERROR converting, **FATAL ERROR, HAS COMPLETED WITH RETURN CODE
 <div id="script">
 <a href="scripts/viewfail" target="_blank">view script</a>
 </div>
  <strong><a href="?log=view99&wcoss=<?=$wcoss?>">RC=99</a></strong><br />
  <font class="courier">$UT/view99</font><br />
  Greps through <font class="courier">/com[2]/logs/jlogfile</font> and <font class="courier">/com[2]/logs/jlogfile.old.*</font> for a variety of failure patterns.
 <div id="script">
 <a href="scripts/view99" target="_blank">view script</a>
 </div>
 </div>
<? # Datacount ?>
 <div id="p" class="gray">
 ...
 <a href="scripts/view22n_4" target="_blank">view script</a>
  ...
  Looks through <font class="courier">/com[2]/logs/jlogfile</font> and <font class="courier">/com[2]/logs/jlogfile.old.*</font> for datacount deficiencies or abundances.
 <div id="script">
...
<? # Miscellaneous ?>
 <div id="p" class="gray">
  ...
  <strong><a href="?log=view22n_9&wcoss=<?=$wcoss?>">All other messages for all networks except rap, rtma, and urma</a></strong><br />
  Looks through <font class="courier">/com[2]/logs/jlogfile</font> and <font class="courier">/com[2]/logs/jlogfile.old.*</font> for any other informational messages for all networks except for rap, rtma, and urma.
 <div id="script">
 <a href="scripts/view22n_9" target="_blank">view script</a>
  ...
  Looks through <font class="courier">/com[2]/logs/jlogfile</font> and <font class="courier">/com[2]/logs/jlogfile.old.*</font> (to cover 24 hours) for summary information from tropical cyclone bogus runs.
 <div id="script">
 <a href="scripts/view22n_10" target="_blank">view script</a>
  ...
  Looks through <font class="courier">/com[2]/logs/jlogfile</font> and <font class="courier">/com[2]/logs/jlogfile.old.*</font> (to cover 24 hours) for "NDAS RESTART FILE NOT FOUND: DO A STATIC ANALYSIS".
 <div id="script">
 <a href="scripts/view22n_11" target="_blank">view script</a>
  ...
  Looks through <font class="courier">/com[2]/logs/jlogfile</font> and <font class="courier">/com[2]/logs/jlogfile.old.*</font> (to cover 24 hours) for "(suddenly offline?)," "30 seconds," "no longer empty!," "still empty."
 <div id="script">
 ...
 <a href="scripts/view22n_18" target="_blank">view script</a>
  ...
  Greps through <br /><font class="courier">/com[2]/hourly/prod/hourly.*/aqm.t12z.status.tm00.bufr_d</font> for "HAS" to key on report counts. 
 <div id="script">
 ...
 Searches through <font class="courier">/com[2]/[nam][gfs]/<?=$wcoss?>/[nam][gfs][gdas].*</font> for "limit has already been reached". 
 <div id="script">
 <a href="scripts/view22n_31" target="_blank">view script</a>
 </div>
  <strong><a href="?log=view22y_6&wcoss=<?=$wcoss?>">Check for "unexpected end of file" in satingest stdout</a></strong><br />
 Searches through <font class="courier">/com/output/<?=$wcoss?>/[date]</font> for "unexpected end of file" in specific satellite ingest standard output files. 
 <div id="script">
 <a href="scripts/view22y_6" target="_blank">view script</a>
 </div>
 </div>
