...
<? $plotlink="stnplts.php"; ?>
 ...
 <div id="menuh-container">
  <div id="menuh">
   ...
   <ul>
     <? if ($grp=="goesfv") {?>
     <li><a href="<?=$plotlink?>?net=<?=$net?>&ccs=<?=$ccs?>" class="top_parent-active">goesfv</a>
     <? } else {?>
     <li><a href="<?=$plotlink?>?net=<?=$net?>&ccs=<?=$ccs?>" class="top_parent">goesfv</a>
     <? } ?>
     <ul>
       <li><a href="<?=$plotlink?>?net=<?=$net?>&ccs=<?=$ccs?>&grp=goesfv&tnk=NC003003" class="sublist">goest1</a></li>
     </ul>
     </li>
   </ul>
   <? ### gpsipw ### ?>
   ...
   <ul>
     <? if ($grp=="gpsro") { ?>
     <li><a href="<?=$plotlink?>?net=<?=$net?>&ccs=<?=$ccs?>&grp=<?=$grp?>&tnk=NC003010" class="active">gpsro</a></li>
     <? } else { ?>
     <li><a href="<?=$plotlink?>?net=<?=$net?>&ccs=<?$ccs?>&grp=gpsro&tnk=NC003010" class="bold">gpsro</a></li>
     <? } ?>
   </ul>
   <? ### msonet ### ?>
   <ul>
   ...
   <ul>
     <? if ($grp=="mtiasi") { ?>
     <li><a href="<?=$plotlink?>?net=<?=$net?>&ccs=<?=$ccs?>&grp=<?=$grp?>&tnk=NC021241" class="active">mtiasi</a></li>
     <? } else { ?>
     <li><a href="<?=$plotlink?>?net=<?=$net?>&ccs=<?$ccs?>&grp=mtiasi&tnk=NC021241" class="bold">mtiasi</a></li>
     <? } ?>
   </ul>
   <? ### nexrad ### ?>
   ...
   <ul>
     <? if ($grp=="nexrad") {?>
     <li><a href="<?=$plotlink?>?net=<?=$net?>&ccs=<?=$ccs?>" class="top_parent-active">nexrad</a>
     <? } else {?>
     <li><a href="<?=$plotlink?>?net=<?=$net?>&ccs=<?=$ccs?>" class="top_parent">nexrad</a>
     <? } ?>
   </ul>
   <? ### osbuv8 ### ?>
   <ul>
     <? if ($grp=="osbuv8") { ?>
     <li><a href="<?=$plotlink?>?net=<?=$net?>&ccs=<?=$ccs?>&grp=<?=$grp?>&tnk=NC008011" class="active">osbuv8</a></li>
     <? } else { ?>
     <li><a href="<?=$plotlink?>?net=<?=$net?>&ccs=<?$ccs?>&grp=osbuv8&tnk=NC008011" class="bold">osbuv8</a></li>
     <? } ?>
   </ul>
   <? ### proflr ### ?>
   <ul>
