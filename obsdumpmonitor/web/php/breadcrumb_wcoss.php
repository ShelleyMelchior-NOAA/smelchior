...
$name="All Messages";
if ($log=="view22y_5")
 {print("$homelink#srucrtma\">SRUC, RTMA</a> $img ${link}$name</a>");}
...
# RC=22
$name=array("view22n_7a"=>"All networks except RAP, SRUC, RTMA",
            "view22n_7b"=>"1b Data Dumps");
...
# RC=11 
if ($log=="viewfail")
 {print("$homelink#failures\">FAILURES</a>");}
# Datacount
...
# Miscellaneous
$name=array("view22n_9"=>"All Other Messages For All Netowrks Except RAP, SRUC, RTMA",
...
if ($log=="view22n_9" || $log=="view22n_10" || $log=="view22n_11" || $log=="view22n_12" || $log=="view22n_13" || $log=="view22n_14" || $log=="view22n_16" || $log=="view22n_18" || $log=="view22n_20" || $log=="view22n_31" || $log=="view22n_30")
