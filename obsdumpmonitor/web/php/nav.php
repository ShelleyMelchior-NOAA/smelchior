...
<!--   <li><a href="stnplts.php?net=ruc2a&wcoss=<?=$wcoss?>" class="sublist" target="_blank">Dump Station Plots</a></li> -->
   ...
   <ul>
     <? if ($log=="view22y_5") {?>
     <li><a href="<?=$homelink?>#srucrtma" class="top_parent-active">RTMA, URMA</a>
     <? } else { ?>
     <li><a href="<?=$homelink?>#srucrtma" class="top_parent">RTMA, URMA</a>
     <? } ?>
     <ul>
...
<!--   <li><a href="stnplts.php?net=rtma&wcoss=<?=$wcoss?>" class="sublist" target="_blank">Dump Station Plots</a></li> -->
   ...
   <ul>
     ...
     <? } ?>
     <ul>
       <li><a href="?log=view22n_7&wcoss=<?=$wcoss?>" class="wrap">All networks except RAP, RTMA, URMA</a></li>
     </ul>
     </li>
   </ul>
   <? ### *.out ### ?>
...
<!--   <li><a href="stnplts.php?net=nam&wcoss=<?=$wcoss?>" target="_blank" class="wrap" target="_blank">Station Plots</a></li> -->
   ...
   <ul>
     ...
     <li><a href="<?=$homelink?>#failures" class="top_parent-active">Failures</a>
     <? } else { ?>
     <li><a href="<?=$homelink?>#failures" class="top_parent">Failures</a>
     <? } ?>
     <ul>
       <li><a href="?log=viewfail&wcoss=<?=$wcoss?>" class="wrap">FAILURES</a></li>
       <li><a href="?log=view99&wcoss=<?=$wcoss?>" class="sublist">RC=99</a></li>
     </ul>
     </li>
   </ul>
   <? ### Datacount ### ?>
   ...
   <ul>
     ...
     <? } ?>
     <ul>
       <li><a href="?log=view22n_9&wcoss=<?=$wcoss?>" class="wrap">All Other Messages For All Networks Except RAP, RTMA, URMA</a></li>
       ...
       <li><a href="?log=view22y_6&wcoss=<?=$wcoss?>" class="wrap">Unexpected end of file in satingest stdout</a></li>
     </ul>
     </li>
   </ul>
