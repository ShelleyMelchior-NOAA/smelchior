...
$log=$_GET['log'];
$wcoss=$_GET['wcoss'];
if ($wcoss != "" && $wcoss != "dev" && $wcoss != "prod")
 {
  print("Invalid wcoss option: \"${_GET['wcoss']}\"");
  exit;
 }

# set date from filestats log (latest run)
#require("date_wcoss.php");
require("date.php");

# if no wcoss selected, default to prod machine
if ($wcoss=="") {$wcoss="prod";}
# determine which machine is prod and which machine is dev
#require("devprod_wcoss.php");
require("devprod.php");
?>

<div id="wrap">
<div id="header">
 <?php #require("header_wcoss.php"); ?>
 <?php require("header.php"); ?>
</div> <!-- header -->

<div id="nav">
 <?php #require("nav_wcoss.php"); ?>
 <?php require("nav.php"); ?>
</div> <!-- nav -->
...
#require("breadcrumb_wcoss.php");
require("breadcrumb.php");
?>
</div>

<? # load appropriate index page based on arguments: $log, $wcoss
if ($log=="" || $log=="home")
# {require("home_wcoss.php");}
 {require("home.php");}
else
 {
  # load selected log file
  #require("logs_wcoss.php");
  require("logs.php");
