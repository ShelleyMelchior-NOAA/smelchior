...
<head>
<title>NOAA - NCEP - EMC - RTMA AWS Pressure</title>
...
<div id="wrap">
<div id="header">
 <strong>RTMA AWS Pressure</strong><br />
 May 13, 2011
</div> <!-- header -->
<div id="nav">
...
var gx = new GGeoXml("http://www.emc.ncep.noaa.gov/mmb/obsdumpmonitor/xml/rtma_aws_final4_pres.kml");
map.addOverlay(gx);
