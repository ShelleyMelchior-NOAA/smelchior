...
# Run dumpjb for global dump group #11:
# amsr2
...
workdir=/gpfs/dell2/stmp/$USER/dumpjb_amsr2_${network}.${PDY}${cyc}.$$
...
echo ${HOMEobsproc_dump}/ush/dumpjb $CDATE $CRAD amsr2 
${HOMEobsproc_dump}/ush/dumpjb $CDATE $CRAD amsr2 
