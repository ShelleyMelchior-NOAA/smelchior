...
# Run dumpjb for global dump group #8:
# satwnd 
...
workdir=/gpfs/dell2/stmp/$USER/dumpjb_satwnd_${network}.${PDY}${cyc}.$$
...
export ADD_satwnd="005024 005025 005026 005030 005031 005032 005034 005039 005072"
