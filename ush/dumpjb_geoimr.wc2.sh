...
# Run dumpjb for global dump group #9:
# geoimr
...
workdir=/gpfs/dell2/stmp/$USER/dumpjb_geoimr_${network}.${PDY}${cyc}.$$
...
echo ${HOMEobsproc_dump}/ush/dumpjb $CDATE $CRAD geoimr 
${HOMEobsproc_dump}/ush/dumpjb $CDATE $CRAD geoimr 
