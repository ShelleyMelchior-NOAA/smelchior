...
# Run dumpjb for dump group: adpsfc 
...
workdir=/gpfs/dell2/stmp/$USER/dumpjb_adpsfc_${network}.${PDY}${cyc}.$$
...
export TANK_000000=$DCOMROOT/dev
export TANK_000001=$DCOMROOT/dev
export TANK_000002=$DCOMROOT/dev
export TANK_000100=$DCOMROOT/dev
export TANK_000101=$DCOMROOT/dev
export TANK_000102=$DCOMROOT/dev

echo $HOMEobsproc_dump/ush/dumpjb $CDATE $CRAD adpsfc
