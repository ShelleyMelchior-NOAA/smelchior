...
#export PDY=20160811 # may need to hard set the date if /com/date/t00z has already been updated
tmmark=$1
if [ $tmmark -eq 00 ]; then
  ...
  test $tmmark -eq 03 && CDATE=${PDYm1}21 
  test $tmmark -eq 06 && CDATE=${PDYm1}18 
  test $tmmark -eq 09 && CDATE=${PDYm1}15 
  test $tmmark -eq 12 && CDATE=${PDYm1}12 
fi
