...
# Run dumpjb for dump group: crisdb 
...
workdir=$stmp/$USER/dumpjb_crisdb_${network}.${PDY}${cyc}.$$
...
export TANK_021212=/gpfs/dell1/nco/ops/dcom/dev

echo $HOMEobsproc_dump/ush/dumpjb $CDATE $CRAD crisdb
$HOMEobsproc_dump/ush/dumpjb $CDATE $CRAD crisdb


# cp *crisdb.ibm to /com location from which dump archive can retrieve the files
