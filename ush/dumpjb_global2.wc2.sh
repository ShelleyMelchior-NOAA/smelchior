...
# Run dumpjb for global dump group #2:
# sfcshp tideg atovs adpsfc ascatt wndsat
...
workdir=/gpfs/dell2/stmp/$USER/dumpjb_global2_${network}.${PDY}${cyc}.$$
...
echo ${HOMEobsproc_dump}/ush/dumpjb $CDATE $CRAD sfcshp tideg atovs adpsfc ascatt wndsat
${HOMEobsproc_dump}/ush/dumpjb $CDATE $CRAD sfcshp tideg atovs adpsfc ascatt wndsat
