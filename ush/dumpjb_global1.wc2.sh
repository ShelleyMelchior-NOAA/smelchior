...
# Run dumpjb for global dump group #1:
# avcsam eshrs3 ssmisu saphir atms 1bhrs4 sevcsr tesac mls esatms crisfs
# gsrcsr ahicsr sstvcw
...
workdir=/gpfs/dell2/stmp/$USER/dumpjb_global1_${network}.${PDY}${cyc}.$$
...
echo ${HOMEobsproc_dump}/ush/dumpjb $CDATE $CRAD avcsam eshrs3 ssmisu saphir atms 1bhrs4 sevcsr tesac mls esatms crisfs gsrcsr ahicsr sstvcw
${HOMEobsproc_dump}/ush/dumpjb $CDATE $CRAD avcsam eshrs3 ssmisu saphir atms 1bhrs4 sevcsr tesac mls esatms crisfs gsrcsr ahicsr sstvcw
