...
# Run dumpjb for global dump group #4:
# aircar aircft gpsipw hdob proflr rassda vadwnd
...
workdir=/gpfs/dell2/stmp/$USER/dumpjb_global4_${network}.${PDY}${cyc}.$$
...
echo ${HOMEobsproc_dump}/ush/dumpjb $CDATE $CRAD aircar aircft gpsipw hdob proflr rassda vadwnd
${HOMEobsproc_dump}/ush/dumpjb $CDATE $CRAD aircar aircft gpsipw hdob proflr rassda vadwnd
